...
classes=['ар-деко','барокко', 'византийский', 'готика', 'романский']
model = torch.jit.load('architecture.pt')
...
def repeat_all_messages(message):
    try:
        ...
        bot.send_message(message.chat.id,text = 'Определено: {}'.format(classes[int(preds)]))
    except Exception:
        traceback.print_exc()
